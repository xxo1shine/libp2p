...
public class ProtoUtilTest {
  ...
  @Test
  public void helloMessageDiscardsUnknown() throws Exception {
    Connect.HelloMessage msg = Connect.HelloMessage.newBuilder()
        .setFrom(endpoint()).setNetworkId(1).setCode(0).setVersion(1).setTimestamp(123).build();
    assertUnknownDiscarded(msg, Connect.HelloMessage.parser());
  }
