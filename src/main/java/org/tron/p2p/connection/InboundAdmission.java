...
public class InboundAdmission {
   ...
   */
  public DisconnectCode register(Channel channel) {
    log.info("register channel {}, size: {}",
    ...
    log.info("register channel {} success, size: {}",
            channel.getInetSocketAddress(), pending.size());
